...
const app = require('APP')
  ...
  const arrCandy = [
      ...
      {name: 'Dark Chocolate Eggs', short_description: 'Made in the U.S.', description: 'A fluffy vanilla marshmallow is dipped in rich dark chocolate and a crunchy candy shell', price: 7.5, quantity: 500, tags: [], numOrdered: 0, status: 'Available', rating: 0, review: [], photo: 'product_photos/dark-chocolate-marshmallow-eggs.jpg'},
      ...
      {name: 'Green Tea Caramels', short_description: 'Imported from France', description: 'These rich & creamy caramels are dipped in white chocolate infused with matcha green tea.', price: 7, quantity: 500, tags: [], numOrdered: 0, status: 'Available', rating: 0, review: [], photo: 'product_photos/matcha-green-tea-caramels.jpg'},
